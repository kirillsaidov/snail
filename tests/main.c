...
void draw_logo(void) {
    ...
    for (size_t i = 0; i < 3; i++) {
        snl_canvas_render_circle(
            ...
            SNL_APPEARANCE(i ? 21 : 0, 1, i ? SNL_COLOR_PALEWHITE : SNL_COLOR_BLACK, 1, SNL_COLOR_NONE, NULL, i ? NULL : "lg0")
        );
    }
    ...
    snl_canvas_render_rectangle(
        ...
        45, SNL_APPEARANCE(0, 1, SNL_COLOR_NONE, 1, SNL_COLOR_PALEWHITE, NULL, NULL)
    );
